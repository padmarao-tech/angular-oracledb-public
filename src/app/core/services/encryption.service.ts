...
export class EncryptionService {
     ...
     * @link https://stackoverflow.com/questions/41222162/encrypt-in-php-openssl-and-decrypt-in-javascript-cryptojs Reference.
     * @link https://stackoverflow.com/questions/25492179/decode-a-base64-string-using-cryptojs Crypto JS base64 encode/decode reference.
     * @param string raw_string The original string to be encrypt.
     * @param string key The key.
     * @return string Return encrypted string.
     */
    encrypt(raw_string: string, key: string) {
        ...
        var encrypted = CryptoJS.AES.encrypt(raw_string, hashKey, { 'mode': CryptoJS.mode.CBC, 'iv': iv });
